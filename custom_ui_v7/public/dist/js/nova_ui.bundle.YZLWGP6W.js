  ...
  animation: zoomOut 0.3s ease forwards;
   ...
   #main-grid {
    ...
    <div class="nova-card" onclick="frappe.set_route('app/dashboard-view/Bottom%2050%20Selling%20Item')">
        <div class="nova-icon c-red"><img src="/assets/custom_ui_v7/images/bottom-selling.png" style="width:60px; height:50px; object-fit: contain;" /></div><div>Bottom 50\xA0selling\xA0items</div>
    </div>
...
//# sourceMappingURL=nova_ui.bundle.YZLWGP6W.js.map
